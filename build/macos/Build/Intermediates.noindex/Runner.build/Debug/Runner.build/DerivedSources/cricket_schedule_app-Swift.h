...
#ifndef CRICKET_SCHEDULE_APP_SWIFT_H
#define CRICKET_SCHEDULE_APP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="cricket_schedule_app",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC20cricket_schedule_app11AppDelegate")
...
SWIFT_CLASS("_TtC20cricket_schedule_app17MainFlutterWindow")
